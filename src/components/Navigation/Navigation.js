...
function Navigation(props) {
    ...
    return (
        <div className="navigation">
            {!props.loggedIn  && <div className="navigation__buttons-container">
            ...
            {props.loggedIn && !showMenu && <div className="navigation__menu-button" onClick={onClick}><img src={menu} alt="Меню"></img></div>}
            {props.loggedIn && showMenu && <div className="navigation__close-button" onClick={onClick}><img className="navigation__close-icon" alt="Закрыть" src={closeIcon}></img></div>}
